...
async def cat(ctx):
    '''
    Котики
    Отправляем случайный jpg файл котиков из списка возможных отправителю команды. 
    :param ctx: author
            prefix
            me
            bot
...
async def meme(ctx):
    '''
    Мем
    Отправляем случайный jpg/jpeg/png файл с мемом отправителю команды.
    :param ctx: author
                prefix
                me
                bot
...
async def anec(ctx):
    '''
    Анекдот
    Отправляем случайно выбранный анекдот отправителю командыю.
    в функцию anec.
    :param ctx: author
                prefix
                me
...
async def coin_flip(ctx):
    ...
    Отправляем результат подбрасывания монетки человеку, который вызвал команд.у
    :param ctx: author
                prefix
                me
                bot
